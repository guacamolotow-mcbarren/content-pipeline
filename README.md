...
| Этапы | Модель |
|-------|--------|
| 1–4, 8–9 | **Composer** — бриф, уточнения, план, ревью плана, согласование, дообучение |
| **5, 6, 7** | **GPT-5.5+** (ChatGPT 5.5) — драфт, редактура, финальное ревью |

Перед этапами 5–7 переключите модель в Cursor вручную.
...
|-------|----------------|--------|
| `content-teamlead` | /start, ревью плана и финала, дообучение | Composer (1, 4, 8, 9); **GPT-5.5+** (7) |
| `content-interviewer` | После brief.md — уточнения | Composer |
| `content-copywriter` | plan.md, draft.md, правки | Composer (3); **GPT-5.5+** (5, 6) |
| `content-editor` | Ревью draft.md | **GPT-5.5+** (6) |
